...
| `watchpost_watch` | Watchpost — Watch plan, one location | C$99/mo (C$990/yr) | recurring monthly (annual optional) | First month free; any month the decoys can't be shown up is free; cancel with one email | Early access; business-hours support, no 24/7 |
...
- **Watchpost, C$99/mo (C$990/yr).** One plan, one location. First month free, no setup fee, business-hours email support and no 24/7 monitoring, said plainly. Roughly a tenth of Thinkst Canary; not comparable to 24/7 MDR products, which it isn't.
...
3. **Watchpost Watch at C$99/mo** — set with the first businesses taken on in early access.
...
- Green Mile / Watchpost annual prices (C$290, C$790, C$990): a second Stripe price on the same product, or offer by email; the site keys are the monthly ones.
